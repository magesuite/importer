...
$image = 'magento_image_configurable.jpg';
include __DIR__.'/../Model/Import/_files/import_image_file.php';
...
$product->setTypeId(Configurable::TYPE_CODE)
    ...
    ->setImage('/m/a/magento_image_configurable.jpg')
    ->setSmallImage('/m/a/magento_image_configurable.jpg')
    ->setThumbnail('/m/a/magento_image_configurable.jpg')
    ->setData('media_gallery', ['images' => [
        [
            'file' => '/m/a/magento_image_configurable.jpg',
            'position' => 1,
...
$image = 'magento_image_configurable_12345.jpg';
include __DIR__.'/../Model/Import/_files/import_image_file.php';
...
$product->setTypeId(Configurable::TYPE_CODE)
    ...
    ->setCategoryIds([$rootCategoryId])
    ->setStockData(['use_config_manage_stock' => 1, 'is_in_stock' => 1])
    ->setImage('/m/a/magento_image_configurable_12345')
    ->setSmallImage('/m/a/magento_image_configurable_12345')
    ->setThumbnail('/m/a/magento_image_configurable_12345')
    ->setData('media_gallery', ['images' => [
        [
            'file' => '/m/a/magento_image_configurable_12345',
            'position' => 1,
            'label' => 'Image Alt Text',
            'disabled' => 0,
            'media_type' => 'image'
